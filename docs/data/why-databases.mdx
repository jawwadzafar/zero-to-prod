...
<Quiz
  ...
  questions={[
    ...
    },
    {
      ...
      answer: 1,
      explain: 'The table definition declares slug as the PRIMARY KEY, so the database enforces uniqueness itself. Constraints in the schema are enforced by the database on every write, from every client. That is integrity you cannot forget to check.',
    },
    {
