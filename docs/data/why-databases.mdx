  ...
  questions={[
    {
      ...
      options: [
        'Both links are saved',
        'One link is silently lost, because the second write overwrites the first',
        'The file becomes encrypted',
        'The operating system merges the two files',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Once it confirms a write, the data survives crashes and restarts',
        'It can store very large files',
        'It is hard to delete',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'snip’s Go code checked for duplicates',
        'The table definition declares slug as the PRIMARY KEY, so the database enforces uniqueness itself',
        'The browser blocked the request',
        'Duplicates are never allowed in any column',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'You describe what data you want, and the database decides how to find it',
        'It can only declare tables, not query them',
        'It requires a declaration file',
      ],
      answer: 1,
