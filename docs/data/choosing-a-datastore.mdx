  ...
  questions={[
    {
      ...
      options: [
        ...
        'They store each column together, so a query reads only the columns it needs, heavily compressed',
        'They skip rows at random',
        'They use more CPU cores than Postgres',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'In a bytea column in the links table',
        'In object storage such as S3, with the object key stored in Postgres',
        'In Redis',
        'In the Go binary',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'The update failed',
        'Replication lag: the replica had not yet received the change from the primary',
        'The browser cached the page',
        'Replicas cannot store profiles',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'New databases are always slower',
        'Every datastore must be run, secured, backed up, monitored, kept in sync and paid for — permanent cost for imagined benefit',
        'Postgres forbids it',
        'You can only use one database per application',
      ],
      answer: 1,
      explain: 'Operational cost is forever. Add specialised stores when a measured need justifies them.',
    },
  ]}
/>
