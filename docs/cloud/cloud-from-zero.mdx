  ...
  questions={[
    {
      ...
      answer: 1,
      explain: 'One or more data centres within a region, with independent power, cooling and networking, connected to the other zones by fast links. Spreading copies across zones survives a data-centre failure without the complexity of multi-region.',
    },
    {
      ...
      answer: 1,
      explain: 'Physics: light in fibre travels about 200 km per ms, so 17,000 km each way takes at least ~170 ms for a round trip. Latency has a floor set by distance. The fix is to put servers near users.',
    },
    {
      ...
      answer: 1,
      explain: 'The customer: configuration, data and access controls are always on the customer’s side. Most cloud breaches are customer-side misconfigurations, not provider hacks.',
    },
    {
    ...
    },
    {
      ...
      answer: 1,
      explain: 'With IaaS you rent VMs and manage the OS and everything above it; with PaaS you give the platform your code or container and it handles the servers. Moving from IaaS to PaaS trades control for less operational work.',
    },
    {
