...
|---|---|---|---|---|
| **IaaS** (infrastructure as a service) | Virtual machines, disks, networks | The OS, runtime, app, scaling, patches | AWS EC2, Azure VMs, GCP Compute Engine | A VM running snip with systemd (chapter 2.6) |
  ...
  questions={[
    {
      ...
      options: [
        'A country',
        'One or more data centres within a region, with independent power, cooling and networking, connected to the other zones by fast links',
        'A price tier',
        'A backup of a region',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'Providers limit it',
        'Physics: light in fibre travels about 200 km per ms, so 17,000 km each way takes at least ~170 ms for a round trip',
        'TLS is slow',
        'Sydney has slow servers',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'The cloud provider',
        'The customer: configuration, data and access controls are always on the customer’s side',
        'Nobody',
    ...
    },
    {
      ...
      options: [
        ...
        'A running managed database, a load balancer or a NAT gateway: they bill by the hour',
    ...
    },
    {
      ...
      options: [
        'There is none',
        'With IaaS you rent VMs and manage the OS and everything above it; with PaaS you give the platform your code or container and it handles the servers',
        'PaaS is only for databases',
        'IaaS is always cheaper to run',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Enable MFA on the root user, set a budget alert, and create a separate everyday identity',
        'Launch a large VM to test it',
