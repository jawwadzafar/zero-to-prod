  ...
  questions={[
    {
      ...
      options: [
        'You should already have known it — it is a basic term every reader is expected to bring',
        'A rung was skipped — that is a bug in the handbook, worth reporting',
        'You should skip ahead to the advanced chapters, where terms are defined properly',
        'Indexes are optional knowledge, so the chapter left the word undefined on purpose',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'To make every chapter the same length, so progress through the handbook feels even',
        'Familiarity feels like understanding but isn’t; doing and self-testing make it stick',
        'Because the labs contain extra material that the chapter itself leaves out',
        'They are optional extras, meant only for readers who already work as engineers',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'Because one system is quicker to write than many separate small examples',
        'The hardest real skill is how pieces fit together, which isolated examples never teach',
        'Because link shorteners are the most common kind of software you’ll be hired to build',
        'Because many small examples would each need their own separate install instructions',
      ],
      answer: 1,
