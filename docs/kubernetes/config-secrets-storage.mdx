...
That's **base64** (chapter 1.4), an *encoding*, not encryption. Anyone can reverse it:
  ...
  questions={[
    {
      ...
      options: [
        'Immediately',
        'Only after they restart, e.g. via kubectl rollout restart, because environment variables are read at start',
        'Within a minute, automatically',
        'Never; ConfigMaps are immutable',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'Anyone reading it: it is encryption',
        'Nothing: it is a reversible encoding. Protection comes from RBAC, encryption at rest and keeping values out of Git',
    ...
    },
    {
      ...
      options: [
        'By base64-encoding them twice',
        'By storing values in a secret manager and syncing them in (External Secrets), or committing only encrypted values (Sealed Secrets, SOPS)',
        'By using ConfigMaps instead',
    ...
    },
    {
      ...
      options: [
        ...
        'A claim requests storage; the StorageClass’s provisioner creates a matching PersistentVolume on demand and binds it to the claim',
        'StorageClasses are backups of claims',
        'Claims are only for ConfigMaps',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'Postgres copies data to the image',
        'The StatefulSet recreates postgres-0, which mounts the same PersistentVolumeClaim, data-postgres-0',
        'The data is in a ConfigMap',
        'Kubernetes backs up every Pod',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'Yes',
        'No: it’s the live disk. Corruption, mistakes and deletions affect it directly. Databases still need tested backups',
        'Only with ReadWriteMany',
        'Only in the cloud',
      ],
      answer: 1,
