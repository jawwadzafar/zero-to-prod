  ...
  questions={[
    {
      ...
      answer: 1,
      explain: 'Letting one app access your data on another service without you giving it your password, with limited and revocable permissions. OAuth delegates limited, revocable access via tokens, instead of sharing full credentials.',
    },
    {
    ...
    },
    {
      ...
      answer: 1,
      explain: 'A standard way to log users in: the openid scope, a signed ID token, discovery and published keys. OAuth is about authorization (what an app may do). OIDC standardises authentication (who the user is) with the ID token.',
    },
    {
