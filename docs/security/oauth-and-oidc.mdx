  ...
  questions={[
    {
      ...
      options: [
        ...
        'Letting one app access your data on another service without you giving it your password, with limited and revocable permissions',
    ...
    },
    {
      ...
      options: [
        'Weak passwords',
        'An intercepted authorization code being exchanged for tokens by an attacker',
        'Slow networks',
    ...
    },
    {
      ...
      options: [
        ...
        'A standard way to log users in: the openid scope, a signed ID token, discovery and published keys',
    ...
    },
    {
      ...
      options: [
        'None, the signature is enough',
        'Tokens issued by the same provider to other apps would be accepted by your API',
        'Tokens will expire too quickly',
        'The API will reject all tokens',
      ],
      answer: 1,
