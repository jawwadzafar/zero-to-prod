  ...
  questions={[
    {
      ...
      options: [
        'Gateways are slow',
        'Only the service knows who owns link Y; gateways can check tokens and scopes, but object-level decisions need the object',
        'Gateways can’t read headers',
        'It shouldn’t; gateways are enough',
      ],
      answer: 1,
      explain: 'Broken object-level authorization is what happens when the object check is missing.',
    },
    {
      q: 'What is role explosion?',
      options: [
        'Roles being deleted by accident',
        'Needing a new role for every combination of permission and specific resource, until roles outnumber people',
        'Too many admins',
    ...
    },
    {
      ...
      options: [
        'It’s allowed',
        'It’s denied, because of default allow := false',
        'OPA errors',
        'It depends on the role',
      ],
      answer: 1,
      explain: 'Deny by default: new actions are refused until a rule explicitly allows them.',
    },
    {
      ...
      options: [
        'Nothing until an admin cleans each folder',
        'It disappears immediately, because it was derived from the membership tuple that was removed',
        'It remains for 30 days',
        'Only her edit access disappears',
      ],
      answer: 1,
      explain: 'Access is computed from relationships at check time, so removing one relationship revokes everything it implied.',
    },
    {
      q: 'Why are tests that assert a refusal ("not allow") especially important for authorization?',
      options: [
        'They run faster',
        'A policy that allows everything passes every "allowed" test; only refusal tests catch over-permissive changes',
        'OPA requires them',
        'They reduce logging',
      ],
      answer: 1,
      explain: 'The dangerous bugs are the ones that grant too much.',
    },
  ]}
/>
