  ...
  questions={[
    {
      ...
      options: [
        'It doesn’t name the queue product',
        'It states no cost: a decision should say what it gives up (counts lag, possible loss) as well as what it gains',
        'Queues should never be used for clicks',
        'It’s too short for an ADR',
      ],
      answer: 1,
      explain: 'Every choice is a trade-off. Naming the cost is what makes it a decision others can evaluate.',
    },
    {
      q: 'Which of these is a one-way door for snip?',
      options: [
        'The cache TTL',
        'The format of generated slugs, because every link ever shared depends on it',
        'The name of an internal Go function',
        'The log level',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'Edit it to describe the new decision',
        'Delete it',
        'Write ADR N describing the new decision and marking it as superseding 4; mark ADR 4 "Superseded by N" and leave its content',
        'Nothing; ADRs are informal',
      ],
      answer: 2,
      explain: 'Records are history. Superseding preserves why things were once done differently.',
    },
    {
      q: 'In the C4 model, what does a container diagram show?',
      options: [
        'Only Docker containers',
        'The separately running applications and data stores inside a system, and how they communicate',
        'Classes and methods',
        'The people who use the system and nothing else',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'Mermaid diagrams look nicer',
        'They’re versioned and reviewed with the code, and updated in the same pull request as the change, so they stay true',
        'Pictures aren’t allowed in repositories',
        'It’s required by C4',
      ],
      answer: 1,
      explain: 'Diagrams go stale when updating them is a separate chore. Next to the code, it’s part of the change.',
    },
  ]}
/>
