...
<Quiz
  ...
  questions={[
    ...
    },
    {
      ...
      options: [
        'Always delete known_hosts and reconnect',
        'Find out why: a rebuilt server explains it; if not, someone may be intercepting the connection',
        'Ignore it — it is cosmetic',
    ...
    },
    {
      ...
      options: [
        'Open port 5432 to the internet temporarily',
        'Use an SSH tunnel: ssh -L 5433:localhost:5432 server, then connect to localhost:5433',
        'Copy the whole database to your laptop',
    ...
    },
    {
      ...
      options: [
        'Keys are shorter',
        'The private key never crosses the network and is far too long to guess; the server only checks a signature',
        'Keys expire every day',
        'Passwords are not encrypted by SSH',
      ],
      answer: 1,
