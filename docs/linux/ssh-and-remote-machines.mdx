...
<Quiz
  ...
  questions={[
    ...
    },
    {
      ...
      answer: 1,
      explain: 'The private key never crosses the network and is far too long to guess; the server only checks a signature. With keys, you prove possession by signing a challenge. There is nothing short to brute-force and nothing secret sent over the wire. Password logins are the main target of internet-wide bot attacks.',
    },
  ]}
/>
