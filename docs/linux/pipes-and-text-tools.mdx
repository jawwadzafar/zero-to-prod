...
<Quiz
  ...
  questions={[
    ...
    },
    {
      ...
      options: [
        'uniq is broken',
        'uniq only merges adjacent duplicates, so you need to sort first',
        'cat changes the lines',
        'The log is too big for uniq',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'sort deletes files it reads',
        'The shell empties data.txt for the > redirection before sort starts reading it',
        'Files cannot be sorted in place',
        'The file was already empty',
      ],
      answer: 1,
