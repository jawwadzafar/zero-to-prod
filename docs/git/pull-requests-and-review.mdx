  ...
  questions={[
    {
      ...
      options: [
        'Ask the most senior reviewers you can find to look at it',
        'Keep it small and focused on one change, with a clear description',
        'Open it late in the day, so reviewers have a quiet evening for it',
        'Add more commits, so each step of your thinking is visible',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'That only the repository owner can read or change it',
        'Changes only via pull requests, with green checks and approvals, no force-push',
        'That main is backed up daily and can be restored by admins',
        'That every commit is signed with the author’s account password',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        '"This is wrong. Please rewrite the whole function before I look at it again."',
        '"I would never write it like this; my way is clearer, see how I did my last PR."',
        '"If Redis is down here, the limiter may block everything — should it fail open?"',
        '"LGTM, looks fine to me" — sent without opening the changed files',
      ],
      answer: 2,
    ...
    },
    {
      ...
      options: [
        'Email the maintainer the corrected file and ask them to commit it',
        'Fork it, push a branch to your fork, and open a pull request to the original',
        'Ask for write access to the repository so you can push the fix',
        'Clone it, fix the typo, and push straight to their main branch',
      ],
      answer: 1,
