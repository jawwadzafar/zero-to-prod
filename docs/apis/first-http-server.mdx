  ...
  questions={[
    {
      ...
      options: [
        'w is the request, r is the response',
        'r is everything the client sent; w is how the handler writes the response',
        'Both are the request body',
        'They are the server’s address and port',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'Only the literal path /{code}; it cannot read it',
        'Any GET /something path; the handler reads it with r.PathValue("code")',
    ...
    },
    {
      ...
      options: [
        ...
        'So a client cannot make the server read an enormous body into memory',
        'Because URLs are always exactly 2048 bytes',
        'LimitReader decrypts the body',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'The map was cleared by the router',
        'Links were only in memory, which is lost when the process stops',
        'The codes expired after one minute',
        'curl caches old results',
      ],
      answer: 1,
