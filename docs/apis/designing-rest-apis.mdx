...
<Quiz
  ...
  questions={[
    ...
    },
    {
      ...
      options: [
        '403 Forbidden, to be accurate',
        '404 Not Found, so it does not confirm the link exists',
        '200 with the link data',
    ...
    },
    {
      ...
      options: [
        'None — POST is idempotent',
        'The link may be created twice, because POST is not idempotent',
        'The server will crash',
        'The API key will be revoked',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'JSON does not allow bare arrays',
        'So fields like next_cursor or total can be added later without breaking clients',
        'It makes responses smaller',
        'Arrays cannot be paginated',
      ],
      answer: 1,
