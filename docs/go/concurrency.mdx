  ...
  questions={[
    {
      ...
      options: [
        'It handles one request at a time, very quickly',
        'It starts a goroutine for each connection, so each request runs concurrently',
        'It starts a new process for every request',
        'It only works on machines with many CPU cores',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'To make it faster',
        'Many request goroutines use the same map at once, and unsynchronised writes cause races or crashes',
        'Maps require a password',
        'To save memory',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Carrying deadlines and cancellation through all the functions working on one task',
        'Logging errors',
        'Creating goroutines',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'Go automatically deletes it after a minute',
        'The goroutine is leaked — it waits forever, holding its memory',
        'The program crashes immediately',
        'The channel sends a zero value',
      ],
      answer: 1,
