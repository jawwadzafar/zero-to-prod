  ...
  questions={[
    {
      ...
      options: [
        'Compiled languages cannot be run on servers',
        'Go translates the whole program to machine code ahead of time, checking it first; an interpreter reads and runs the code each time',
        'Interpreted languages have no variables',
        'Compiled code is always written in capital letters',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'Nothing — it prints 3links',
        'A mismatched types error: you cannot add an int and a string',
        'It prints 3 and ignores "links"',
        'It crashes when the program runs',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Fix the first one, rebuild, and repeat — later errors are often caused by the first',
        'Delete the file and start again',
        'Ignore them and run the program anyway',
      ],
      answer: 1,
