  ...
  questions={[
    {
      ...
      answer: 1,
      explain: 'Go translates the whole program to machine code ahead of time, checking it first; an interpreter reads and runs the code each time. Compiling happens once, before running, and catches many mistakes early. The output is a standalone program file. An interpreter translates and runs your code every time it executes.',
    },
    {
