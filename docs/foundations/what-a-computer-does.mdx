...
<Quiz
  ...
  questions={[
    ...
    },
    {
      ...
      options: [
        'The CPU is too slow — buy a faster one',
        'The server is waiting on something slower, such as storage or another machine over the network',
        'The server has too many cores',
        'The page has too many words',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Programs get faster to free memory',
        'The OOM killer stops a process to free memory',
        'The disk gets deleted',
      ],
      answer: 2,
