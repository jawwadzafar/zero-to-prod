...
<Quiz
  ...
  questions={[
    ...
    },
    {
      ...
      options: [
        '302 is faster',
        'Browsers remember 301 redirects permanently, so later clicks would bypass snip and not be counted',
        '301 is not allowed for short links',
        '302 is encrypted and 301 is not',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'The server remembers your IP address forever',
        'The client sends proof (a cookie or token) with every request',
        'The connection stays open all day',
        'HTTPS stores your login',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        '401 meant "I don’t know who you are"; 403 means "I know who you are, and you’re not allowed"',
        '403 means the server crashed',
        '401 means the page moved',
      ],
      answer: 1,
