...
<Quiz
  ...
  questions={[
    ...
    },
    {
      ...
      answer: 1,
      explain: 'Browsers remember 301 redirects permanently, so later clicks would bypass snip and not be counted. A 301 tells browsers the move is permanent, so they may cache it and never ask snip again. A 302 keeps every click coming through snip, where it can be counted — and lets a link be changed or deleted later.',
    },
    {
