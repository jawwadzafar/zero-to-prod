  ...
  questions={[
    {
      ...
      options: [
        'The database lost data',
        'UTF-8 bytes were read as if they were a different, older encoding',
        'The customer typed their name wrong',
        'The report is using too small a font',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'As the floating-point number 19.99',
        'As the whole number 1999 (cents), or in a decimal type such as NUMERIC',
        'As the text "nineteen ninety-nine"',
        'As a Unix timestamp',
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        'Yes — Base64 is a strong encryption method',
        'Only if the text is long enough',
        'No — Base64 is an encoding anyone can reverse instantly',
        'Yes, as long as the file is YAML',
      ],
      answer: 2,
    ...
    },
    {
      ...
      options: [
        'Store each time in the user’s local time zone',
        'Store and process in UTC; convert to local time only for display',
        'Store only the date, never the time',
        'Store times as plain text like "next Tuesday"',
      ],
      answer: 1,
